...
// Or faXTwitter if you’re using the new X logo

import React from "react";

export default function Footer() {
  return (
    <footer className="bg-black text-white min-h-[432px] max-w-[1600px]">
      <div className="grid grid-cols-1 lg:grid-cols-5 text-center lg:text-left gap-4 p-10 text-gray-400">
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-xl font-semibold pt-10 text-white ">Services</h2>
          <p>Products & Services</p>
          <p>Customer Stories</p>
          <p>Download Apps</p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="text-xl font-semibold pt-10 text-white">Information</h2>
          <p>Privacy Policy</p>
          <p>Terms & Conditions</p>
          <p>Join Us</p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="text-xl font-semibold pt-10 text-white ">Social Links</h2>
